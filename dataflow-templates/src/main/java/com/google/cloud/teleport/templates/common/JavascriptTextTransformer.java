...
public abstract class JavascriptTextTransformer {
  ...
  public interface JavascriptTextTransformerOptions extends PipelineOptions {
    ...
    @Description("UDF Javascript CLI parameters")
    ValueProvider<String> getJavascriptTextTransformConfigurations();

    void setJavascriptTextTransformConfigurations(
            ValueProvider<String> javascriptTextTransformConfigurations);
  }
  ...
  public abstract static class JavascriptRuntime {
     ...
     * @param configs second parameter to pass to the invocable function
     * @return The data transformed by the UDF in String format
     */
    @Nullable
    public String[] invoke(String data, String configs) throws ScriptException, IOException, NoSuchMethodException {
      Invocable invocable = getInvocable();
      if (invocable == null) {
        throw new RuntimeException("No udf was loaded");
      }

      Object result = getInvocable().invokeFunction(functionName(), data, configs);
  ...
  public abstract static class TransformTextViaJavascript
    ...
    public abstract @Nullable ValueProvider<String> scriptConfigs();
    ...
    public abstract static class Builder {
      ...
      public abstract Builder setScriptConfigs(@Nullable ValueProvider<String> scriptConfigs);
      ...
      return strings.apply(
          ParDo.of(
              new DoFn<String, String>() {
                ...
                private String scriptConfigsStr;
                ...
                public void setup() {
                  ...
                  if (scriptConfigs() != null) {
                    scriptConfigsStr = Strings.nullToEmpty(scriptConfigs().get());
                  }
                }
                ...
                public void processElement(ProcessContext c)
                  ...
                  if (javascriptRuntime != null) {
                    result = javascriptRuntime.invoke(element, scriptConfigsStr);
                  } else {
                    result = new String[1];
                    result[0] = element;
                  }
  ...
  public abstract static class FailsafeJavascriptUdf<T>
    ...
    public abstract static class Builder<T> {
      ...
      public abstract Builder<T> setScriptConfigs(@Nullable ValueProvider<String> scriptConfigs);
                  ...
                  new DoFn<FailsafeElement<T, String>, FailsafeElement<T, String>>() {
                    ...
                    public void processElement(ProcessContext context) {
                      ...
                      try {
                        String[] res;
                        if (javascriptRuntime != null) {
                          res = javascriptRuntime.invoke(payloadStr, scriptConfigsStr);
                        } else {
                          res = new String[1];
                          res[0] = payloadStr;
                        }
